...
import com.poldroc.retry.test.support.listens.MyListens;
...
public class SpringRecoverServiceImpl implements SpringRecoverService {
    ...
    @Override
    @Retry(recover = MyRecover.class,listen = MyListens.class,waits = @RetryWait(value = 2000, retryWait = FixedRetryWait.class))
